    ...
    public partial class Home : ComponentBase
    {
        ...
        private async Task OpenFilterDialog()
        {
            ...
            if (result is not null && !result.Canceled && result.Data is ClientFilter newFilter)
            {
                ...
                searchQuery = currentFilter.SearchQuery ?? string.Empty; // Sync search query
                await LoadClients();
        ...
        private async Task OnSearchChanged(string newSearchQuery)
        {
            ...
            // Only reload if we have other active filters or the search is meaningful
        ...
        private async Task EditClient(Client client)
        {
            ...
            try
            {
                ...
                await LoadClients(); // Reload to apply current filters
        ...
        private async Task OpenAddClientDialog()
        {
            ...
            try
            {
                ...
                await LoadClients(); // Reload to apply current filters
                await LoadFilterData(); // Reload filter data as new client might add new years/countries
